...
export function mySqlErrorHandlerUtils(err: mySQL.MysqlError, dbHost?: string | null,
    ...
    switch (err.code) {
        case "EAI_AGAIN":
            ...
            logErrorName();
            console.log(`[ ${colors.red(`${colors.bold('DataBase connection')}`)} ] | ${dateTime} | [ ${colors.red(`${colors.bold(`error`)}`)} ] | [ ${colors.bold(`Type error`)} ] ${colors.red(`${Exception.mysqlErrorCon} : ${colors.bold(`EAI_AGAIN`)}`)} - [ ${colors.bold(`Error message`)} ] ${colors.red(`${Exception.errorDBHost(dbHost!)}`)} - [ ${colors.red(`${colors.bold(`HttpCode`)}`)} ] ${colors.red(`${colors.bold(`${HttpStatusCodesConstant.UNAUTHORIZED}`)}`)} `);
            break;
        case "ER_NOT_SUPPORTED_AUTH_MODE":
            LoggerComponent.logErrorMessage(Exception.erNotSupportedAuthMode, Exception.mysqlErrorCon);
            logErrorName();
            console.log(`[ ${colors.red(`${colors.bold('DataBase connection')}`)} ] | ${dateTime} | [ ${colors.red(`${colors.bold(`error`)}`)} ] | [ ${colors.bold(`Type error`)} ] ${colors.red(`${Exception.mysqlErrorCon} : ${colors.bold(`ER_NOT_SUPPORTED_AUTH_MODE`)}`)} - [ ${colors.bold(`Error message`)} ] ${colors.red(`${Exception.erNotSupportedAuthMode}`)} - [ ${colors.red(`${colors.bold(`HttpCode`)}`)} ] ${colors.red(`${colors.bold(`${HttpStatusCodesConstant.UNAUTHORIZED}`)}`)} `);
            break;
        case "ER_ACCESS_DENIED_ERROR":
            LoggerComponent.logErrorMessage(Exception.accessDeniedToDBCon(user!, password!), Exception.mysqlErrorCon);
            logErrorName();
            console.log(`[ ${colors.red(`${colors.bold('DataBase connection')}`)} ] | ${dateTime} | [ ${colors.red(`${colors.bold(`error`)}`)} ] | [ ${colors.bold(`Type error`)} ] ${colors.red(`${Exception.mysqlErrorCon} : ${colors.bold(`ER_ACCESS_DENIED_ERROR`)}`)} - [ ${colors.bold(`Error message`)} ] ${colors.red(`${Exception.accessDeniedToDBCon(user!, password!)}`)} - [ ${colors.red(`${colors.bold(`HttpCode`)}`)} ] ${colors.red(`${colors.bold(`${HttpStatusCodesConstant.UNAUTHORIZED}`)}`)}`);
            break;
        case "ER_BAD_DB_ERROR":
            LoggerComponent.logErrorMessage(Exception.unknownDB(database!), Exception.mysqlErrorCon);
            logErrorName();
            console.log(`[ ${colors.red(`${colors.bold('DataBase connection')}`)} ] | ${dateTime} | [ ${colors.red(`${colors.bold(`error`)}`)} ] | [ ${colors.bold(`Type error`)} ] ${colors.red(`${Exception.mysqlErrorCon} : ${colors.bold(`ER_BAD_DB_ERROR`)}`)} - [ ${colors.bold(`Error message`)} ] ${colors.red(`${Exception.unknownDB(database!)}`)} - [ ${colors.red(`${colors.bold(`HttpCode`)}`)} ] ${colors.red(`${colors.bold(`${HttpStatusCodesConstant.NOT_FOUND}`)}`)}`);
            break;
        default:
            LoggerComponent.logErrorMessage(err.message, Exception.mySQLError);
            console.log(`[ ${colors.red(`${colors.bold('DataBase connection')}`)} ] | ${dateTime} | [ ${colors.red(`${colors.bold(`error`)}`)} ] | [ ${colors.bold(`Type error`)} ] ${colors.red(`${Exception.mysqlErrorCon} : ${colors.bold(`MysqlError`)}`)} - [ ${colors.bold(`Error message`)} ] ${colors.red(`${err.message}`)} - [ ${colors.red(`${colors.bold(`HttpCode`)}`)} ] ${colors.red(`${colors.bold(`${HttpStatusCodesConstant.GONE}`)}`)}`);
    }
}
